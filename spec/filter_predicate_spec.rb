...
describe Filter::PredicateSplitter do
  describe '#split_key' do
    describe 'successful' do
      let(:splitter){ Filter::PredicateSplitter.new( 'birth_year_like', 'fifteeen' ) }
    ...
    describe 'unsuccessful' do
      let(:splitter){ Filter::PredicateSplitter.new 'birth_year', 'fifteeen' }
      it 'returns false' do
    ...
    describe 'custom predicate' do
      let(:splitter){ Filter::PredicateSplitter.new( 'custom_predicate', 'fifteeen' ) }
  ...
  describe '#fv' do
    it 'returns field as symbol and value' do
      splitter = Filter::PredicateSplitter.new 'birth_year', 'fifteeen'
  ...
  describe '#ev' do
    ...
    it 'returns qualified expression and value' do
      splitter = Filter::PredicateSplitter.new 'departments__birth_year', 'fifteeen'
      expr, value = splitter.ev
...
describe Filter do
  ...
  describe '#expressions' do
    ...
    it 'accepts []' do
      expressions = Filter.new( flavours: [] ).expressions
      expressions.size.should == 1
      expressions.first.should be_a(Sequel::SQL::BooleanExpression)
      expr, value = expressions.first.args
      expr.should be_a(Sequel::SQL::Identifier)
      expr.value.should == 'flavours'
      value.should == []
    end
  end
